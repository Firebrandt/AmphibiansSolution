...
val moshi : Moshi = Moshi.Builder()
    // This is so the JSON annotations work proper with Kotlin.
    .add(KotlinJsonAdapterFactory())
    .build()


// Use Moshi to parse this garbo into the class.
...
interface AmphibianApiService {
    ...
    // Make a GET request at this endpoint, cast it into this list.
    @GET("android-basics-kotlin-unit-4-pathway-2-project-api.json")
    suspend fun getAmphibiansList() : List<Amphibian>
}

object amphibAPI {
    // Make retrofit implement the interface we define. Store it here conveniently.
